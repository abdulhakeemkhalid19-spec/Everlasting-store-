  ...
  if (fetching) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{background: '#0d0305'}}>
        <p className="text-yellow-400 text-xl">✨ Loading product...</p>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen" style={{background: '#0d0305'}}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <div className="mb-8">
          <p className="text-xs font-bold tracking-widest uppercase mb-1" style={{color: '#f6d365'}}>Edit Item</p>
        ...
        <div className="card p-6 space-y-5">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-4 rounded-xl font-black text-lg transition-all hover:scale-105 disabled:opacity-40"
