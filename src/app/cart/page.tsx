        ...
        {cart.length === 0 ? (
          ...
          <div className="flex flex-col gap-6">
                  ...
                  <div key={item.id} className="card p-4 flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        {item.compare_price && (
                          <p className="text-xs line-through" style={{color: 'rgba(44,44,44,0.4)'}}>₦{item.compare_price.toLocaleString()}</p>
                        )}
                      </div>
                    </div>
            ...
            <div className="card p-6">
              ...
              <div className="border-t pt-3 space-y-2 mb-4" style={{borderColor: 'rgba(135,206,235,0.3)'}}>
                ...
                <div className="flex justify-between font-black text-xl pt-2" style={{borderTop: '1px solid rgba(135,206,235,0.2)'}}>
              ...
              <div className="rounded-xl p-4 mb-4" style={{background: 'rgba(37,211,102,0.08)', border: '1px solid rgba(37,211,102,0.2)'}}>
                ...
                <p className="text-xs" style={{color: 'rgba(44,44,44,0.5)'}}>
                  Fill in your details above then click the button below to send your order!
                </p>
              </div>
